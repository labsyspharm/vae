...
class Config:
    ...
    def from_path(cls, path):
        ...
        config.AAD = bool(data['AAD'])
        config.AAD_model_path = pathlib.Path(data['AAD_model_path']).resolve()
        ...
        config.tiles_per_chunk = int(data['tiles_per_chunk'])
        ...
        config.leiden_k = int(data['leiden_k'])
        config.leiden_r = float(data['leiden_r'])
